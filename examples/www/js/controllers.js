...
(function (angular) {
	...
	angular.module('app.controllers', [])
		...
		.controller('demoIonicSelectboxCtrl', ['$scope', '$stateParams',
		...
		.controller('inlineSearchExampleCtrl', ['$scope', '$stateParams', 'geoData',
			// The following is the constructor function for this page's controller. See https://docs.angularjs.org/guide/controller
			// You can include any angular dependencies as parameters for this function
			// TIP: Access Route Parameters for your page via $stateParams.parameterName
		...
		.controller('groupedDisplayExampleCtrl', ['$scope', '$stateParams', 'geoData',
			// The following is the constructor function for this page's controller. See https://docs.angularjs.org/guide/controller
			// You can include any angular dependencies as parameters for this function
			// TIP: Access Route Parameters for your page via $stateParams.parameterName
			function ($scope, $stateParams, geoData) {
				...
				gCtrl.parseDepartment = function (deptCode) {
					return (_.find(gCtrl.departments, {
				...
				$scope.$watch(angular.bind(this,
					...
					function (newVal, oldVal) {
						if (newVal !== oldVal) {
							gCtrl.cityDepartment = _.find(gCtrl.departments, {
								departmentCode: newVal.deptCode
							});
		...
		.controller('extraInformationExampleCtrl', ['$scope', '$stateParams', 'geoData',
			// The following is the constructor function for this page's controller. See https://docs.angularjs.org/guide/controller
			// You can include any angular dependencies as parameters for this function
			// TIP: Access Route Parameters for your page via $stateParams.parameterName
			function ($scope, $stateParams, geoData) {
				...
				eCtrl.parseDepartment = function (deptCode) {
					return (_.find(eCtrl.departments, {
						departmentCode: deptCode
					})).departmentName;
				};
				...
				$scope.$watch(angular.bind(this,
					...
					function (newVal, oldVal) {
						if (newVal !== oldVal) {
							eCtrl.cityDepartment = _.find(eCtrl.departments, {
								departmentCode: newVal.deptCode
							});
		...
		.controller('gridController', ['$scope', '$stateParams', 'geoData',
			// The following is the constructor function for this page's controller. See https://docs.angularjs.org/guide/controller
			// You can include any angular dependencies as parameters for this function
			// TIP: Access Route Parameters for your page via $stateParams.parameterName
			function ($scope, $stateParams, geoData) {
				...
				gridCtrl.parseDepartment = function (deptCode) {
					return (_.find(gridCtrl.departments, {
						departmentCode: deptCode
					})).departmentName;
				};
